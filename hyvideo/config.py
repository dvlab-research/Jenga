...
def add_inference_args(parser: argparse.ArgumentParser):
    ...
    group.add_argument(
        ...
        type=str,
        default="",
        help="post fix for the saved video"
    )
    ...
    group.add_argument(
        ...
        default=[0.0],
        nargs="+",
        help="self-attention drop rates",
    )
    group.add_argument(
        "--txt-block-num",
        type=int,
        default=2,
        help="number of text blocks",
    )
    group.add_argument(
        "--curve-type",
        type=str,
        default="block-neighbor",
        # choices=["no_neighbor", "linear"],
        help="curve type",
    )
    # --- disable-txt-amp ---
    group.add_argument(
    ...
    # --- scheduler_shift_list ---
    group.add_argument(
        "--scheduler-shift-list",
        type=int,
        default=[7],
        nargs="+",
        help="scheduler_shift_list",
    )
    # --- p_remain_rates ---
    group.add_argument(
        "--p-remain-rates",
    ...
    group.add_argument(
        ...
        type=int,
        default=1,
        help="total number of gpu threads",
    )
    # ---current gpu thread id ---
    group.add_argument(
        "--cur-id",
        type=int,
        default=0,
        help="current gpu thread id",
    )
    group.add_argument(
        "--seed-type",
        type=str,
