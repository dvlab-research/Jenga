...
def parallelize_transformer(pipe):
    ...
    def new_forward(
        ...
        res_rate_list: list[int] = [1.0],
        step_rate_list: list[int] = [1.0],
        scheduler_shift_list: list[int] = [7],
    ):
...
class Inference(object):
    ...
    def load_state_dict(args, model, pretrained_model_path):
        ...
        logger.info(f"Loading torch model {args.dit_weight}...")
...
class HunyuanVideoSampler(Inference):
    ...
    def predict(
       ...
       embedded_guidance_scale: {embedded_guidance_scale}"""
        ...
        print(f"sa_drop_rate in predict func: {sa_drop_rate}")
