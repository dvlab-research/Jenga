...
def block_sparse_attention_combined(
    ...
    text_blocks: int = 4,  # Number of text blocks at the end
    text_amp: float = 1.0,  # text_amp
    prob_threshold: float = 0.5,  # p_remain_rate
    ...
    if normal_blocks > 0:
        ...
        if pad > 0:
            query_normal = query_normal.contiguous()
